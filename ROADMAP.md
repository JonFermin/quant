...
- [ ] **P0 · M** Add reproducible runner CLI (`python -m strategies.lgbm_alpha158` + args for config path, date overrides, output dir).
  - Goal: one-command local/Colab execution with explicit artifacts.

- [ ] **P0 · M** Add validation + smoke tests for config/strategy wiring.
...
- [ ] **P1 · S** Fix documentation drift in `CLAUDE.md` architecture tree (`example_lgbm.py` -> `lgbm_alpha158.py`).
